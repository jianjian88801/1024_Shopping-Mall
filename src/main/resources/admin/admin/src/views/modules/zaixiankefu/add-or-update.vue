<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
                        <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'" label="客服编号" prop="kefubianhao">
            <el-input v-model="ruleForm.kefubianhao" 
                placeholder="客服编号" readonly></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.kefubianhao" label="客服编号" prop="kefubianhao">
              <el-input v-model="ruleForm.kefubianhao" 
                placeholder="客服编号" readonly></el-input>
          </el-form-item>
        </div>
          ...
          <el-form-item class="input" label="商家姓名" prop="shangjiaxingming">
              <el-input v-model="ruleForm.shangjiaxingming" 
                placeholder="商家姓名" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="客服回复" prop="kefuhuifu">
          <el-input v-model="ruleForm.kefuhuifu" 
              placeholder="客服回复" clearable  :readonly="ro.kefuhuifu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="客服回复" prop="kefuhuifu">
              <el-input v-model="ruleForm.kefuhuifu" 
                placeholder="客服回复" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                              </el-row>
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
          	            if(o=='kefubianhao'){
            this.ruleForm.kefubianhao = obj[o];
	    this.ro.kefubianhao = true;
            continue;
          }
	            	            if(o=='neirong'){
	    ...
	    this.ro.shangjiaxingming = true;
            continue;
	            	            ...
	            	            if(o=='kefuhuifu'){
            this.ruleForm.kefuhuifu = obj[o];
	    this.ro.kefuhuifu = true;
            continue;
          }
	                    }
                                                                                                                              }
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `zaixiankefu/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.zaixiankefuCrossAddOrUpdateFlag = false;
                  this.parent.search();
